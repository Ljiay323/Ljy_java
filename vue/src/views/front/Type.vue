      ...
      <div style="width: 250px; padding: 0 20px; border-left: #cccccc 1px solid">
        ...
        <div style="margin: 20px 0; padding: 0 10px">
          <div style="margin-bottom: 20px">
            ...
            <div style="margin-top: 10px; font-weight: 500; font-size: 16px; width: 180px; color: #000000FF; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;">当季水果</div>
            <div style="margin-top: 5px; font-size: 20px; color: #FF5000FF">￥ 44 / 件</div>
          </div>
          <div>
            <img @click="navTo('/front/detail?id=' + item.id)" src="@/assets/imgs/carousel-1.png" alt="" style="width: 100%; height: 175px; border-radius: 10px; border: #cccccc 1px solid">
            <div style="margin-top: 10px; font-weight: 500; font-size: 16px; width: 180px; color: #000000FF; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;">热卖肉食</div>
            <div style="margin-top: 5px; font-size: 20px; color: #FF5000FF">￥ 44 / 件</div>
          </div>
        </div>
      </div>
