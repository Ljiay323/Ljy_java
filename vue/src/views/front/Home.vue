<template>
  <div class="main-content">
    <div style="height: 60px; background-color: #d4fd97"></div>
    <div style="display: flex">
      <div class="left"></div>
      <div style="width: 66%; background-color: white; height: 1000px">
        <div style="color: #1bb9f3; margin: 15px 0 15px 18px; font-weight: bold; font-size: 16px">主题市场</div>
        ...
        <div style="margin: 40px 0 0 15px; height: 40px; background-color: #f32c09; font-size: 20px; color: white; width: 130px; font-weight: bold; line-height: 40px; text-align: center; border-radius: 20px">热卖商品</div>
